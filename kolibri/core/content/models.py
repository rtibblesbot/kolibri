...
The generate_schema command only freezes export schema versions, so adding a field
here does not require running it. See base_models.py for when a new export schema
version is needed.
"""
